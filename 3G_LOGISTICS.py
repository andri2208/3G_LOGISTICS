        ...
        <body>
            <div id="inv">
                ...
                <table class="footer-table">
                    <tr>
                        <td style="width:60%;"><b>TRANSFER TO:</b><br>BCA 6720422334<br>ADITYA GAMA SAPUTRI<br>NB :<br> Jika sudah transfer mohon konfirmasi ke <br>Finance: 082179799200</td>
